...
gnome-terminal --tab -- bash -c "s2;roslaunch roslaunch mini_rig_description ur5_real.launch; exec bash"
...
gnome-terminal --tab -- bash -c "s2;roslaunch cares_hand_eye_calibration realsense_handeye_calibration.launch; exec bash"
